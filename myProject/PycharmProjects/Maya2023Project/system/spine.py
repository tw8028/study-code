...
class Spine:
    ...
    def __init__(self, *, joints: list[str]):
        self.system_spine = f'system__c__spine__001'
        self.spines = joints
        self.spines_ik = []
        self.loc_list = []
        ...
        self.ctrl_pelvis = f'ctrl__c__pelvis__001'
    ...
    def create_spline_ik(self):
        pm.group(name=self.system_spine, empty=True)
        ...
        curve = spline_ik[2]
        pm.parent(ik_handle, curve, self.system_spine)
    ...
    def create_ctrl(self):
        ...
        mytools.cv_target(name=self.ctrl_pelvis, target=self.spines[2], shape='circle', radius=15)
        ...
        pm.parent(self.zero_cog, self.system_spine)
