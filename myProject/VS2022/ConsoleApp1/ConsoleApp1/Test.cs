...
internal static class TestDirectory
{
    ...
    private static void TestEpubDirectory(string directoryPath, ref int totalFiles,
        Dictionary<string, int> filesByVersion, List<string> filesWithErrors)
    {
    ...
    private static void TestEpubFile(string epubFilePath, Dictionary<string, int> filesByVersion,
        List<string> filesWithErrors)
    {
        ...
        try
        {
            ...
            Console.WriteLine(
                $"Total files: {bookRef.Content.AllFiles.Local.Count}, HTML files: {bookRef.Content.Html.Local.Count}," +
